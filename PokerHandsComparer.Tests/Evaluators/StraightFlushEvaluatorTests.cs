...
namespace PokerHandsComparer.Tests.Evaluators
{
    ...
    public class StraightFlushEvaluatorTests
    {
        ...
        private static IEnumerable<object[]> GetEvaluationTestData()
        {
            ...
            yield return new object[] { new Hand(Card.Spades.Ten, Card.Spades.Nine, Card.Spades.Eight, Card.Spades.Seven, Card.Spades.Six), true };
            yield return new object[] { new Hand(Card.Spades.Ten, Card.Spades.Nine, Card.Spades.Eight, Card.Spades.Seven, Card.Spades.Five), false };
            yield return new object[] { new Hand(Card.Spades.Ace, Card.Spades.Two, Card.Spades.Three, Card.Spades.Four, Card.Spades.Five), true };
        }
    }
}
